...
function! airline#themes#base16_atelierforest#refresh()
  let s:background = get(g:, 'base16_atelierforest_bg', &background)
  let s:gui00 = "#1b1918"
  let s:gui01 = "#2c2421"
  let s:gui02 = "#68615e"
  let s:gui03 = "#766e6b"
...
call airline#themes#base16_atelierforest#refresh()
