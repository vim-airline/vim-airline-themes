...
function! airline#themes#base16_atelierdune#refresh()
  let s:background = get(g:, 'base16_atelierdune_bg', &background)
  let s:gui00 = "#20201d"
  let s:gui01 = "#292824"
  let s:gui02 = "#6e6b5e"
  let s:gui03 = "#7d7a68"
...
call airline#themes#base16_atelierdune#refresh()
